...
#define XD_VK_ERROR_FILE_DATA_EXINFO "from " + std::string(__FILE__) + " line=" + std::to_string(__LINE__) + "\n"
...
namespace XD::Render::Vk::VkMgr
{
    ...
    /// @param err result
    void checkVkResultCType(VkResult err, std::string exInfo = "");

    /// @brief c++ 风格的 vk::Result 检查
    /// @param err result
    void checkVkResult(vk::Result err, std::string exInfo = "");
